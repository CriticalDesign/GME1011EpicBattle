namespace GME1011A4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Here is our hero: " + hero + "\n\n");
            ...
            //TODO: change this so that it can contain goblins and skellies! Just change the type of the array!!
            Goblin[] baddies = new Goblin[numBaddies];
            ...
            for (int i = 0; i < baddies.Length; i++)
            {
                ...
                //TODO: each baddie position should have 50% chance of being a goblin, 50% chance of
                //being a skellie. A skellie should have random health between 25 and 30, and 0 armour (remember
                //skellie armour is 0 anyway)
                baddies[i] = new Goblin(rng.Next(30, 35), rng.Next(1, 5), rng.Next(1, 10));
            ...
            while (numAliveBaddies > 0 && !hero.isDead())
            {
                ...
                //NOTE to coders - armour affects how much damage goblins take, and skellies take half damage - remember that
                ...
                if (baddies[indexOfEnemy].isDead())
                {
                    ...
                    Console.WriteLine("Enemy #" + (indexOfEnemy+1) + " has been dispatched.");
                }
